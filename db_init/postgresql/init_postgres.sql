...
CREATE EXTENSION pg_stat_statements; -- allow odm to perform GetQueries

-- safety first, remove anything existing
DROP TABLE IF EXISTS webshop.production.stocks;
DROP TABLE IF EXISTS webshop.production.products;
DROP TABLE IF EXISTS webshop.production.categories;
DROP TABLE IF EXISTS webshop.production.brands;
